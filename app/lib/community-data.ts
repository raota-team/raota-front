...
export const mockComments: Record<number, Comment[]> = {
  1: [
    { id: 1, author: 'RamenFan', avatar: '🍥', content: '저도 거기 자주 가요! 진한 츠케멘 최고죠', date: '2024.03.18', likes: 3 },
    { id: 2, author: 'FoodieKim', avatar: '👨‍🍳', content: '매운 츠케멘도 진짜 맛있어요. 도전해보세요!', date: '2024.03.18', likes: 5 },
  ],
  2: [
    { id: 1, author: 'NoodleLover', avatar: '🍜', content: '아지타마 꿀팁 감사해요! 다음에 꼭 추가해봐야겠어요', date: '2024.03.17', likes: 8 },
    { id: 2, author: 'SeoulEats', avatar: '🥢', content: '밥 말아먹는건 진리죠 ㅎㅎ', date: '2024.03.17', likes: 12 },
  ],
  3: [
    { id: 1, author: 'LocalGuide', avatar: '🗺️', content: '오레노 추천드려요! 강남역 근처인데 크리미해요', date: '2024.03.16', likes: 6 },
    { id: 2, author: 'ChickenGod', avatar: '🐓', content: '저도 오레노 좋아해요. 카라 파이탄도 맛있어요!', date: '2024.03.16', likes: 4 },
  ],
  4: [
    { id: 1, author: 'ChickenLover', avatar: '🐔', content: '제 질문글 보고 가셨군요! 저도 가봐야겠어요', date: '2024.03.15', likes: 2 },
  ],
  5: [
    { id: 1, author: 'TravelKorea', avatar: '✈️', content: '부산 가면 꼭 들러볼게요!', date: '2024.03.14', likes: 1 },
  ],
  6: [
    { id: 1, author: 'JiroMaster', avatar: '💪', content: '처음엔 면 반(쇼메), 야채 보통(후츠우)으로 콜하세요!', date: '2024.03.13', likes: 15 },
    { id: 2, author: 'RamenVet', avatar: '🎖️', content: '꼭 빈 속에 가지 마시고, 배고플 때 가세요 ㅎㅎ', date: '2024.03.13', likes: 9 },
  ],
};
