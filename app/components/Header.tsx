  ...
  return (
    <>
      ...
      <div 
        ...
        className={`fixed inset-y-0 right-0 z-[70] w-full max-w-72 bg-white pt-14 pb-safe md:hidden transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
